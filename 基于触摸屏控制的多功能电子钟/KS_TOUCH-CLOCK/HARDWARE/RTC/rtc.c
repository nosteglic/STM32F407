...
u8 My_RTC_Init(void)
{
	...
	if(RTC_ReadBackupRegister(RTC_BKP_DR0)!=0x5000)		//是否第一次配置?
	{
    ...
    RTC_Init(&RTC_InitStructure);
		...
		RTC_Set_Time(14,00,00,RTC_H12_AM);	//设置时间
		RTC_Set_Date(20,11,5,4);		//设置日期
	 
		RTC_WriteBackupRegister(RTC_BKP_DR0,0x5000);	//标记已经初始化过了
	} 
